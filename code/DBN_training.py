...
import numpy as np
import timeit
from baseline import load_labeled_data
...
if __name__ == "__main__":
    auc_train, acc_train, tpr_train, tnr_train,auc_valid, acc_valid, tpr_valid, tnr_valid,auc_test, acc_test, tpr_test, tnr_test, pretrain_time, finetune_time = dbn_training()
